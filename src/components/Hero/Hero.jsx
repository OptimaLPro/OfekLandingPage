...
const Hero = () => {
    return (
        <div className="hero-container h-screen bg-[#fff3e7]">
                ...
                <div className="col-span-6 ">
                    <div className="flex items-center justify-end h-screen">
                        <div className="grid grid-rows-12 text-right gap-8 w-[80%] text-xl">
                            ...
                            <div className="row-span-4 text-[28px] heebo-font mr-4">
                                Tel Aviv, Israel | 052-5054201 | ofeksh1471@gmail.com
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-span-6 ">
                    <img src={Ofek} className="object-contain h-screen" alt="Ofek Shmuely" />
                </div>
            </div>
        </div>
    );
